...
export default function Home() {
  ...
  return (
    <>
        ...
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-6">
              <a href="#" className="text-gray-300 hover:text-white text-sm transition">Features</a>
              <a href="#" className="text-gray-300 hover:text-white text-sm transition">API</a>
              <a href="#" className="text-gray-300 hover:text-white text-sm transition">Pricing</a>
              <a href="#" className="text-gray-300 hover:text-white text-sm transition">Support</a>
              <button className="bg-white text-black px-6 py-2.5 rounded-full text-sm font-medium hover:bg-gray-100 transition">
                Sign In
              </button>
            </div>
          </div>
      ...
      {/* Hero Section */}
      <section ref={heroRef} className="min-h-screen bg-black text-white pt-20">
        <div className="max-w-7xl mx-auto px-6 py-24">
          <div className="text-center">
            ...
            <p className="hero-subtitle text-xl md:text-2xl text-gray-400 mb-12 max-w-4xl mx-auto">
              Accept payments in Bitcoin, Ethereum, USDT, and other digital currencies anonymously with Paybin
              <br />start accepting crypto payments today!
            </p>
            
            <div className="hero-buttons flex flex-col sm:flex-row gap-4 justify-center items-center mb-16">
              <button className="bg-white text-black px-8 py-4 rounded-full text-lg font-medium hover:bg-gray-100 transition">
                Get Started
              </button>
              <button className="border border-gray-600 text-white px-8 py-4 rounded-full text-lg font-medium hover:bg-white/10 transition">
                Learn More
              </button>
            </div>
      ...
      {/* Features Section */}
      <section ref={featuresRef} className="features-section bg-zinc-950 text-white py-24">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="feature-item bg-zinc-900 rounded-2xl p-8 hover:bg-zinc-800 transition">
              <div className="text-4xl mb-4">⚡</div>
              <h3 className="text-2xl font-semibold mb-3">Scalable to Fit Your Growth</h3>
            ...
            <div className="feature-item bg-zinc-900 rounded-2xl p-8 hover:bg-zinc-800 transition">
              <div className="text-4xl mb-4">📊</div>
              <h3 className="text-2xl font-semibold mb-3">Real-Time Analytics Dashboard</h3>
              <p className="text-gray-400">
            ...
            <div className="feature-item bg-zinc-900 rounded-2xl p-8 hover:bg-zinc-800 transition">
              <div className="text-4xl mb-4">🔧</div>
              <h3 className="text-2xl font-semibold mb-3">Comprehensive API Integration</h3>
              <p className="text-gray-400">
            ...
            <div className="feature-item bg-zinc-900 rounded-2xl p-8 hover:bg-zinc-800 transition">
              ...
              <h3 className="text-2xl font-semibold mb-3">Advanced Merchant Tools</h3>
              <p className="text-gray-400">
            ...
            <div className="feature-item bg-zinc-900 rounded-2xl p-8 hover:bg-zinc-800 transition">
              <div className="text-4xl mb-4">📈</div>
              <h3 className="text-2xl font-semibold mb-3">Scalable for Growing Businesses</h3>
              <p className="text-gray-400">
            ...
            <div className="feature-item bg-zinc-900 rounded-2xl p-8 hover:bg-zinc-800 transition">
              <div className="text-4xl mb-4">💸</div>
              <h3 className="text-2xl font-semibold mb-3">Instant Settlement, Zero Delay</h3>
              <p className="text-gray-400">
      ...
      {/* Platform Section */}
      <section ref={platformRef} className="platform-section bg-black text-white py-24">
        <div className="max-w-7xl mx-auto px-6">
          <div className="space-y-24">
            {/* Remittance Platform */}
            <div className="platform-card grid md:grid-cols-2 gap-12 items-center">
              <div>
                <h3 className="text-4xl md:text-5xl font-bold mb-6">
                  Remittance Platform for Businesses<br />
                  <span className="text-gray-400">(B2C Customer Wallets)</span>
                </h3>
      ...
      <footer className="bg-zinc-950 text-white py-12 border-t border-zinc-800">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center text-sm text-gray-400">
            ...
            <p>
              <a href="mailto:support@paybin.io" className="hover:text-white transition">
                support@paybin.io
              </a>
            </p>
          </div>
